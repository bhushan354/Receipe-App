...
ActiveRecord::Schema[7.1].define(version: 2024_01_30_060856) do
  ...
  create_table "receipe_foods", force: :cascade do |t|
    ...
    t.index ["recipe_id"], name: "index_receipe_foods_on_recipe_id"
  end
  ...
  add_foreign_key "receipe_foods", "recipes"
